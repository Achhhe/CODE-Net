...
def main():
    ...
    input_folder = '/home/spl/anaconda2/envs/pth10-py36-cu10/deraining_esrgan/datasets/train/jorder/rain_data_train_Heavy/img/norain'
    save_folder = '/home/spl/anaconda2/envs/pth10-py36-cu10/deraining_esrgan/datasets/train/jorder/rain_data_train_Heavy/croped/gt'
    n_thread = 20
    crop_sz = 256
    step = 128
    thres_sz = 48
...
def worker(path, save_folder, crop_sz, step, thres_sz, compression_level):
    ...
    for x in h_space:
        for y in w_space:
            ...
            #print(img_name.replace('x2.png', '_s{:03d}.png'.format(index)))
